    ...
    >
      <div className="mx-auto grid max-w-[1200px] bg-black bg-opacity-45 px-4 lg:bg-opacity-0">
        <div className="flex h-[500px] w-full flex-col justify-center lg:w-[70%]">
          ...
          <form
            action=""
            className="mt-2 flex w-[90%] items-center self-start rounded-full bg-white pl-2 lg:w-[65%] lg:pl-4"
          >
            ...
            <input
              type="submit"
              value="Search"
              className="h-full rounded-r-full bg-blue-600 px-6 py-2 font-semibold text-white lg:py-4"
            />
          </form>
        </div>
      </div>
